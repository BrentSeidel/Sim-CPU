...
As a result, currently no status is set or interrupts generated on output.  The output is assumed to complete instantly.

\subsubsection{Basic Serial Port}
...
\subsubsection{Single Line Telnet Port}
...
\subsubsection{Multi-Line Telnet Port}
...
\subsubsection{Tape}
From the point of view of the host program, the ``paper'' tape just reads bytes and writes bytes.
...
It currently supports 16 bit DMA, but may be extended to support 32 bit DMA.
