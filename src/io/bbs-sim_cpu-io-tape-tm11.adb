...
--
--  This package contains a TM11 paper tape punch/reader.
--
with Ada.Exceptions;
with Ada.Text_IO;
package body BBS.Sim_CPU.io.tape.tm11 is
   --  ----------------------------------------------------------------------
   --  This is an I/O device for a TM11 paper tape reader/punch.  It is
   ...
   --
   procedure openIn(self : in out tm11; name : String) is
   begin
   ...
   --
   function read_tape(self : in out tm11) return data_bus is
      t : byte;
   begin
   ...
   exception
      when e : others =>
         Ada.Text_IO.Put_Line("TM11: Error reading from file: " &
