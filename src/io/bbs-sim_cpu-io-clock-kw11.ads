...
package BBS.Sim_CPU.io.clock.KW11 is
   ...
   --
   overriding
   procedure write(self : in out kw11; addr : addr_bus; data : data_bus; size : bus_size; status : in out bus_stat);
   --
   --  Read from a port address
   --
   overriding
   function read(self : in out kw11; addr : addr_bus; size : bus_size; status : in out bus_stat) return data_bus;
   --
