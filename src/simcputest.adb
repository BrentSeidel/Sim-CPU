...
--   test_util.cpu.variant(BBS.Sim_CPU.i8080.variants_i8080'Pos(BBS.Sim_CPU.i8080.var_8085));
   test_util.cpu.variant(BBS.Sim_CPU.m68000.variants_m68000'Pos(BBS.Sim_CPU.m68000.var_68000));
   ...
   test_util.cpu.attach_io(test_util.fd'Access, 16#00FF_FF03#, BBS.Sim_CPU.BUS_MEMORY);
