;
;  Lisp test cases for 8085 simulator
(sim-cpu "8085")
;
;-------------------------------------------------------------------------------
...
(test-int-dis)
;-------------------------------------------------------------------------------
;  Test 8085 specific Interrupts
;
; Load memory
;
(memw #x0024 #xfbc9) ; EI/RET
(memw #x002c #xfbc9) ; EI/RET
(memw #x0034 #xfbc9) ; EI/RET
(memw #x003c #xfbc9) ; EI/RET
;
(memb #x0100 #xfb)   ; EI
(memb #x0101 #x00)   ; NOP
(memb #x0102 #x00)   ; NOP
...
;
(terpri)
(print "==> Testing 8085 specific interrupts")
(terpri)
(sim-init)
(go #x0100)
(sim-step) ; EI
...
(test-reg RPC #x0102)
(test-int-en)
(send-int #xffffffff) ; TRAP interrupt
...
(sim-step) ; NOP
(test-reg RPC #x0103)
(send-int #xffffff75) ; RST 7.5 interrupt
(sim-step) ; Process interrupt
(test-reg RPC #x003c)
(test-int-dis)
(sim-step) ; EI
...
(sim-step) ; NOP
(test-reg RPC #x0104)
(send-int #xffffff65) ; RST 6.5 interrupt
(sim-step) ; Process interrupt
(test-reg RPC #x0034)
(test-int-dis)
(sim-step) ; EI
...
(sim-step) ; NOP
(test-reg RPC #x0105)
(send-int #xffffff55) ; RST 5.5 interrupt
(sim-step) ; Process interrupt
(test-reg RPC #x002c)
(test-int-dis)
(sim-step) ; EI
...
(test-reg RPC #x010d)
(test-int-en)
(sim-step) ; Process pending RST 5.5 interrupt
(test-reg RPC #x002c)
(test-int-dis)
(sim-step) ; EI
(test-reg RPC #x002d)
...
(test-int-en)
;-------------------------------------------------------------------------------
;  Test 8085 SIM/RIM Instructions
;
; Load memory
;
(memw #x0024 #xfbc9) ; EI/RET (trap)
(memw #x002c #xfbc9) ; EI/RET (RST 5.5)
(memw #x0034 #xfbc9) ; EI/RET (RST 6.5)
(memw #x003c #xfbc9) ; EI/RET (RST 7.5)
;
(memw #x0100 #x3e0c) ; LD A,0C
(memb #x0102 #x30)   ; SIM
(memb #x0103 #xfb)   ; EI
(memb #x0104 #xaf)   ; XOR A
(memb #x0105 #x20)   ; RIM
(memb #x0106 #x20)   ; RIM
(memb #x0107 #x00)   ; NOP
(memw #x0108 #x3e0a) ; LD A,0A
(memb #x010a #x30)   ; SIM
(memb #x010b #xaf)   ; XOR A
(memb #x010c #x20)   ; RIM
(memb #x010d #x20)   ; RIM
(memb #x010e #x00)   ; NOP
(memw #x010f #x3e09) ; LD A,09
(memb #x0111 #x30)   ; SIM
(memb #x0112 #xaf)   ; XOR A
(memb #x0113 #x20)   ; RIM
(memb #x0114 #x20)   ; RIM
(memb #x0115 #xfb)   ; EI
(memw #x0116 #x3e0c) ; LD A,0C
(memb #x0118 #x30)   ; SIM
(memb #x0119 #xaf)   ; XOR A
(memb #x011a #x20)   ; RIM
(memw #x011b #x3e18) ; LD A,18
(memb #x011d #x30)   ; SIM
(memb #x011e #x20)   ; RIM
(memb #x011f #x00)   ; NOP
(memb #x0120 #x00)   ; NOP
...
;
(terpri)
(print "==> Testing 8085 SIM/RIM instructions")
(terpri)
(sim-init)
(go #x0100)
(print "> Mask RST 7.5")
...
(test-int-en)
(send-int 0)
(sim-step) ; Process interrupt (NOP)
(test-reg RPC #x0115)
(sim-step) ; NOP
(test-reg RPC #x0116)
(print "> Clear pending RST 7.5")
(sim-step) ; LD A,0C
(test-reg RA #x0c)
(test-reg RPC #x0118)
(sim-step) ; SIM
